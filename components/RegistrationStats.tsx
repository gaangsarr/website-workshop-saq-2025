      ...
      <section className="py-16 md:py-24 bg-teal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="bg-white rounded-[2.5rem] p-8 border-2 border-black shadow-xl"
          >
    ...
    <section className="py-16 md:py-24 bg-teal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white rounded-[2.5rem] p-6 md:p-8 border-2 border-black shadow-xl"
        >
          {/* Header */}
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-white backdrop-blur-sm px-4 py-2 rounded-full border-2 border-black">
                <div
          ...
          {/* Progress Bar */}
          <div className="bg-gray-50 rounded-2xl p-6 mb-6 border-2 border-black shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-2xl p-6 border-2 border-black shadow-lg"
            >
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 rounded-2xl p-5 border-2 border-black shadow-lg">
            ...
            <div className="bg-gray-50 rounded-2xl p-5 border-2 border-black shadow-lg">
              ...
              <p className="text-xs text-gray-600">Auto-refresh 10s</p>
            </div>
          </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-yellow-700 mt-1">
                  Hanya tersisa {stats.sisaKuota} slot lagi. Daftar sekarang
                  sebelum kehabisan!
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-red-700 mt-1">
                  Kuota {stats.isPresale ? "pre-sale" : "pendaftaran"} sudah
                  terisi penuh.
                </p>
              </div>
            </motion.div>
