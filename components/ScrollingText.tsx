          ...
          {[...Array(5)].map((_, i) => (
            <div key={`first-${i}`} className="flex items-center">
              <h2 className="font-heading font-black text-6xl md:text-8xl lg:text-9xl px-8">
                <span className="text-kuning text-stroke-desktop text-stroke">
                  WORKSHOP{" "}
                </span>
                <span className="text-biru text-stroke-desktop text-stroke">
                  SAQ{" "}
                </span>
                <span className="text-pink text-stroke-desktop text-stroke">
                  2025
                </span>
              </h2>
